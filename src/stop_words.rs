...
static STOP_WORDS: [&str; 2369] = [
    ...
    "Apparently", "Appear", "Appreciate", "Appropriate", "Approximately", "Are", "Aren", "Arent",
    "Aren't", "Arise", "Around", "As", "Aside", "Ask", "Asking", "Associated", "At", "Auth",
    "Available", "Away", "Awfully", "Back", "Be", "Became", "Because", "Become", "Becomes",
    ...
    "Beyond", "Bill", "Both", "Bottom", "Brief", "Briefly", "But", "Call", "Came", "Can", "Cannot",
    "Cant", "Can't", "Cause", "Causes", "Certain", "Certainly", "Changes", "Clearly", "C'mon",
    ...
    "Cry", "Currently", "Date", "Definitely", "Describe", "Described", "Despite", "Detail", "Did",
    "Didn", "Didn't", "Different", "Do", "Does", "Doesn", "Doesn't", "Doing", "Don", "Done",
    "Don't", "Down", "Downwards", "Due", "During", "Each", "Effect", "Eight", "Eighty", "Either",
    "Eleven", "Else", "Elsewhere", "Empty", "End", "Ending", "Enough", "Entirely", "Especially",
    "Et-al", "Etc", "Even", "Ever", "Every", "Everybody", "Everyone", "Everything", "Everywhere",
    "Ex", "Exactly", "Example", "Except", "Far", "Few", "Fifteen", "Fifth", "Fify", "Fill", "Find",
    "Fire", "First", "Five", "Fix", "Followed", "Following", "Follows", "For", "Former", "Formerly",
    "Forth", "Forty", "Found", "Four", "From", "Front", "Full", "Further", "Furthermore", "Gave",
    "Get", "Gets", "Getting", "Give", "Given", "Gives", "Giving", "Go", "Goes", "Going", "Gone",
    "Got", "Gotten", "Greetings", "Had", "Hadn", "Hadn't", "Happens", "Hardly", "Has", "Hasn",
    ...
    "Hers", "Herself", "Hes", "He's", "Hi", "Hid", "Him", "Himself", "His", "Hither", "Home",
    "Hopefully", "How", "Howbeit", "However", "How's", "Http", "Hundred", "Ibid", "Id", "I'd", "If",
    "Ignored", "I'll", "I'm", "Immediate", "Immediately", "Importance", "Important", "Inasmuch",
    "Inc", "Indeed", "Index", "Indicate", "Indicated", "Indicates", "Information", "Inner",
    "Insofar", "Instead", "Interest", "Into", "Invention", "Inward", "Is", "Isn", "Isn't", "It",
    "Itd", "It'd", "It'll", "Its", "It's", "Itself", "I've", "Just", "Keep", "Keeps", "Kept",
    "Know", "Known", "Knows", "Largely", "Last", "Lately", "Later", "Latter", "Latterly", "Least",
    "Les", "Less", "Lest", "Let", "Lets", "Let's", "Like", "Liked", "Likely", "Line", "Little",
    "Look", "Looking", "Looks", "Ltd", "Made", "Mainly", "Make", "Makes", "Many", "May", "Maybe",
    "Me", "Mean", "Means", "Meantime", "Meanwhile", "Merely", "Might", "Mightn", "Mightn't", "Mill",
    "Million", "Mine", "Miss", "More", "Moreover", "Most", "Mostly", "Move", "Mr", "Mrs", "Ms",
    "Mt", "Much", "Mug", "Must", "Mustn", "Mustn't", "My", "Myself", "Name", "Namely", "Nay",
    ...
    "Nowhere", "Obtain", "Obtained", "Obviously", "Of", "Off", "Often", "Oh", "Ok", "Okay", "Old",
    "Om", "Omitted", "On", "Once", "One", "Ones", "Only", "Onto", "Or", "Ord", "Other", "Others",
    "Otherwise", "Ought", "Our", "Ours", "Ourselves", "Out", "Outside", "Over", "Overall", "Ow",
    "Owing", "Own", "Page", "Pagecount", "Pages", "Part", "Particular", "Particularly", "Past",
    ...
    "Proud", "Provides", "Put", "Que", "Quickly", "Quite", "Ran", "Rather", "Readily", "Really",
    "Reasonably", "Recent", "Recently", "Ref", "Refs", "Regarding", "Regardless", "Regards",
    "Related", "Relatively", "Research", "Research-articl", "Respectively", "Resulted", "Resulting",
    "Results", "Right", "Run", "Said", "Same", "Saw", "Say", "Saying", "Says", "Sec", "Second",
    "Secondly", "Section", "See", "Seeing", "Seem", "Seemed", "Seeming", "Seems", "Seen", "Self",
    "Selves", "Sensible", "Sent", "Serious", "Seriously", "Seven", "Several", "Shall", "Shan",
    "Shan't", "She", "Shed", "She'd", "She'll", "Shes", "She's", "Should", "Shouldn", "Shouldn't",
    "Should've", "Show", "Showed", "Shown", "Showns", "Shows", "Side", "Significant",
    "Significantly", "Similar", "Similarly", "Since", "Sincere", "Six", "Sixty", "Slightly", "So",
    ...
    "Suggest", "Sup", "Sure", "System", "Take", "Taken", "Taking", "Tell", "Ten", "Tends", "Than",
    ...
    "Thus", "Til", "To", "Together", "Too", "Took", "Top", "Toward", "Towards", "Tried", "Tries",
    "Truly", "Try", "Trying", "Twelve", "Twenty", "Twice", "Two", "U201d", "Um", "Under",
    "Unfortunately", "Unless", "Unlike", "Unlikely", "Until", "Unto", "Up", "Upon", "Ups", "Ur",
    "Us", "Use", "Used", "Useful", "Usefully", "Usefulness", "Uses", "Using", "Usually", "Value",
    "Various", "Very", "Via", "Viz", "Vol", "Vols", "Volumtype", "Want", "Wants", "Was", "Wasn",
    "Wasnt", "Wasn't", "Way", "We", "Wed", "We'd", "Welcome", "Well", "We'll", "Well-b", "Went",
    ...
    "Whose", "Why", "Why's", "Widely", "Will", "Willing", "Wish", "With", "Within", "Without",
    "Won", "Wonder", "Wont", "Won't", "Words", "World", "Would", "Wouldn", "Wouldnt", "Wouldn't",
    "Yes", "Yet", "You", "Youd", "You'd", "You'll", "Your", "Youre", "You're", "Yours", "Yourself",
    "Yourselves", "You've", "Zero", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday",
    "Saturday", "Sunday", "January", "February", "March", "April", "May", "June", "July", "August",
    "September", "October", "November", "December", "A", "I", "Able,", "About,", "Above,", "Abst,",
